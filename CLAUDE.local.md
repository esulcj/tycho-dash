...
**YOU ARE IN: `dash/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/dash/` (rig root) or other directories
...
**Your mail address:** `dash/polecats/rust`
**Your rig:** dash
**Your Witness:** `dash/witness`
...
| Ask Witness for help | `gt mail send dash/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`dash/witness`) when:
...
```bash
gt mail send dash/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
